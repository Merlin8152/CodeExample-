...
class FPZ_SkillTreeStructureEditorMode : public FApplicationMode
{

public:

	FPZ_SkillTreeStructureEditorMode(const TSharedPtr<FPZ_SkillTreeGraph>& InSkillTreeGraphEditor);
