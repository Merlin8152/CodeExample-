...
class FPZ_UIPositionGraphDrawingConnectionPolicy : public FConnectionDrawingPolicy
{
...
public:
	...
	FPZ_UIPositionGraphDrawingConnectionPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
